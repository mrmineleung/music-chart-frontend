...
const Header = () => {
  ...
  return (<>
    {/* <header className="fixed inset-x-0 top-0 z-50 bg-slate-100 dark:bg-slate-800 bg-opacity-70 dark:bg-opacity-70"> */}
      <header className={`sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 ${visible? '' : 'bg-white dark:bg-slate-900/75 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06]'} `}>
...
<div className="mx-auto max-w-2xl py-2 sm:py-2 lg:py-4">
