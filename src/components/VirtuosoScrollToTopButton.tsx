...
interface VirtuosoScrollToTopButtonProps {
  virtuosoRef: MutableRefObject<VirtuosoHandle | null> | null
}

export default function VirtuosoScrollToTopButton({virtuosoRef} : VirtuosoScrollToTopButtonProps) {
